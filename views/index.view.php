...
/**
 * @var App\Weather\WeatherInfo $info
 */
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    ?>
    <div class="app-container" style="background-image: url(<?php echo e($backgroundImages[$info->weatherType]) ?>); ">
        <div class="top-bar">
        ...
        <div class="weather-info">
            ...
            ?>
            <img class="weather-info__image" src="<?php echo e($topImages[$info->weatherType]) ?>" alt="Stormy" />
            <h1 class="weather-info__temperature"><?php echo e($info->getTemperatureF()) ?>°</h1>
